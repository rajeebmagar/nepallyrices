...
export module ShareLinks {
    ...
    export function fbShare(args: ShareArgs) {
        let shareUrl = 'https://www.facebook.com/dialog/share?app_id=1728334104052385&display=popup&href=' + args.url;
        if(args.tags){
            shareUrl += '&hashtag=' + encodeURIComponent(args.tags) 
        }
        if(args.description){
            shareUrl += '&quote=' + args.description
        }
        return shareUrl;
    }
